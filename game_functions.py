...
def check_play_button(ai_settings,screen,stats,sb,play_button,ship,aliens,buttets,mouse_x,mouse_y):
    """在玩家单击play按钮时开始游戏"""
...
def create_alien(ai_settings,screen,aliens,alien_number,row_number):
    ...
    alien_y=alien.rect.height+2*alien.rect.height*row_number
    alien.rect.y=alien_y
    """此处不可漏中间变量，使得每一个外星人update的alien.x都一样"""
